...
class Shirt extends Item {
	...
	protected static $description = 'Baumwolle, kleidsames Schwarz, selbstverständlich mit #om14-Logo. Achtung: nur bis 20.08. 12:00 Uhr mittags bestellbar! Kein Versand, müssen auf der #om14 abgeholt werden!';
